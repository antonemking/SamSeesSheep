"""3-way held-out benchmark: v0.4 vs v0.5 vs v0.6 on IMG_3651.

Outputs into ./artifacts:
  v0.6-on-IMG_3651.mp4                    Ultralytics-annotated inference
  v0.4-vs-v0.5-vs-v0.6-IMG_3651.mp4      3-up side-by-side
  v0.4-vs-v0.5-vs-v0.6-IMG_3651.png      4-frame stills grid
  ear_angle_lines-v04v05v06-IMG_3651.png  ear angle σ chart
  bench_report-IMG_3651-v04v05v06.json    headline numbers
"""
...
def make_ear_angle_chart(targets: dict, fps: float, out_path: Path):
    ...
    n = b - a
    t = np.arange(n) / fps
    colors = {"v0.4": V04_RGB, "v0.5": V05_RGB, "v0.6": V06_RGB}
    ...
    fig.suptitle(
        "Ear angle — v0.4 vs v0.5 vs v0.6 on held-out IMG_3651\n"
...
if __name__ == "__main__":
    ...
    _, v06_kpts, v06_all = predict_clip(V06, "v0.6")

    cap = cv2.VideoCapture(str(CLIP))
    fps = cap.get(cv2.CAP_PROP_FPS) or 30.0
    cap.release()

    chart_path = ART / f"ear_angle_lines-v04v05v06-{CLIP.stem}.png"
    make_ear_angle_chart(
        {"v0.4": v04_kpts, "v0.5": v05_kpts, "v0.6": v06_kpts},
        fps, chart_path,
    )
    print(f"\nEar angle chart -> {chart_path}")

    sxs_path = ART / f"v0.4-vs-v0.5-vs-v0.6-{CLIP.stem}.mp4"
    make_sxs(
        ["v0.4", "v0.5", "v0.6"],
        [V04_BGR, V05_BGR, V06_BGR],
        [v04_all, v05_all, v06_all],
        sxs_path,
    )
    print(f"SxS video -> {sxs_path}")

    stills_path = ART / f"v0.4-vs-v0.5-vs-v0.6-{CLIP.stem}.png"
    make_stills(
        ["v0.4", "v0.5", "v0.6"],
        [V04_BGR, V05_BGR, V06_BGR],
        [v04_kpts, v05_kpts, v06_kpts],
        [v04_all, v05_all, v06_all],
        stills_path,
    )
    ...
    a, b = WINDOW
    report = {}
    for label, kpts in [("v0.4", v04_kpts), ("v0.5", v05_kpts), ("v0.6", v06_kpts)]:
    ...
    report_path = ART / f"bench_report-{CLIP.stem}-v04v05v06.json"
